...
Source: [core/node/libp2p/rcmgr_defaults.go](https://github.com/bluzelle/ipfs-kubo/blob/master/core/node/libp2p/rcmgr_defaults.go)

### User Supplied Override Limits
Once Kubo has the [Computed Default Limits](#computed-default-limits), it then applies any user-supplied [`Swarm.ResourceMgr.Limits`](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/config.md#swarmresourcemgrlimits) on top.
...
Sources:
* [kubo resource manager logging](https://github.com/bluzelle/ipfs-kubo/blob/master/core/node/libp2p/rcmgr_logging.go)
...
This can be observed with an empty [`Swarm.ResourceMgr.Limits`](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/config.md#swarmresourcemgrlimits)

<!-- Last updated during [v0.18.0 release](https://github.com/bluzelle/ipfs-kubo/issues/9417) -->
...
- [ ] Publish the release to [DockerHub](https://hub.docker.com/r/bluzelle/ipfs-kubo/) <details><summary>using `./kuboreleaser --skip-check-before --skip-run release --version vX.Y.Z(-rcN) publish-to-dockerhub` or ...</summary>
  ...
  - [ ] verify the image is available on [Docker Hub](https://hub.docker.com/r/bluzelle/ipfs-kubo/tags)
...
- [ ] ![](https://img.shields.io/badge/only-FINAL-green?style=flat-square) ![](https://img.shields.io/badge/not-PATCH-yellow?style=flat-square) Create a dependency update PR
  - [ ] ![](https://img.shields.io/badge/only-FINAL-green?style=flat-square) ![](https://img.shields.io/badge/not-PATCH-yellow?style=flat-square) check out [bluzelle/ipfs-kubo](https://github.com/bluzelle/ipfs-kubo)

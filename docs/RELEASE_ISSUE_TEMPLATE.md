<!-- Last updated by @galargh during [0.17.0 release](https://github.com/bluzelle/ipfs-kubo/issues/9319) -->

> Release Issue Template.  If doing a patch release, see [here](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/PATCH_RELEASE_TEMPLATE.md)
...
- [ ] **Stage 0 - Prerequisites**
  ...
  - [ ] Prepare changelog proposal in [docs/changelogs/vX.Y.md](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/changelogs/).
  ...
  - [ ] Ensure you have `kubo` checked out under `$(go env GOPATH)/src/github.com/bluzelle/ipfs-kubo`. This is required by the changelog creation script.
    - If you want your clone to live in a different location, you can symlink it to the expected location by running `mkdir -p $(go env GOPATH)/src/github.com/ipfs && ln -s $(pwd) $(go env GOPATH)/src/github.com/bluzelle/ipfs-kubo`.
...
- [ ] **Stage 2 - Release Candidate** - _if any [non-trivial](docs/releases.md#footnotes) changes need to be included in the release, return to this stage_
  ...
  - [ ] If it's a first RC, create a draft PR targetting `release` branch if it doesn't exist yet ([example](https://github.com/bluzelle/ipfs-kubo/pull/9306)).
  ...
  - [ ] Cut a pre-release on [GitHub](https://github.com/bluzelle/ipfs-kubo/releases) ([instructions](https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository#creating-a-release), [example](https://github.com/bluzelle/ipfs-kubo/releases/tag/v0.17.0-rc1))
    - Use `vX.Y.Z-rcN` as the tag.
    - Link to the release issue in the description.
    - Link to the relevant [changelog](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/changelogs/) in the description.
    - Check `This is a pre-release`.
  - [ ] Synchronize release artifacts by running [sync-release-assets](https://github.com/bluzelle/ipfs-kubo/actions/workflows/sync-release-assets.yml) workflow.
  - [ ] Announce the RC
    ...
    - [ ] Mention [early testers](https://github.com/ipfs/go-ipfs/tree/master/docs/EARLY_TESTERS.md) in the comment under the release issue ([example](https://github.com/bluzelle/ipfs-kubo/issues/9319#issuecomment-1311002478)).
...
- [ ] **Stage 5 - Release** - _ONLY FOR FINAL RELEASE_
  ...
  - [ ] Cut the release on [GitHub](https://github.com/bluzelle/ipfs-kubo/releases) ([instructions](https://docs.github.com/en/repositories/releasing-projects-on-github/managing-releases-in-a-repository#creating-a-release), [example](https://github.com/bluzelle/ipfs-kubo/releases/tag/v0.17.0))
    - Use `vX.Y.Z` as the tag.
    - Copy the relevant [changelog](https://github.com/bluzelle/ipfs-kubo/blob/release/docs/changelogs/) into the release description.
    - Keep the release notes as trim as possible (e.g. remove top headers where possible, [example](https://github.com/bluzelle/ipfs-kubo/releases/tag/v0.17.0))
  - [ ] Synchronize release artifacts by running [sync-release-assets](https://github.com/bluzelle/ipfs-kubo/actions/workflows/sync-release-assets.yml) workflow.
  ...
  - [ ] Announce the release
    ...
    - [ ] Check if Discourse post was automatically copied to:
      ...
      - [ ] FIL Slack #ipfs-chatter
      - [ ] Matrix
  - [ ] Add a link from release notes to Discuss post (like we did here: https://github.com/bluzelle/ipfs-kubo/releases/tag/v0.17.0)
  ...
  - [ ] Get the blog post created
    - [ ] Submit a request for blog post creation using [the form](https://airtable.com/shrNH8YWole1xc70I).
      ...
      - URL: https://github.com/bluzelle/ipfs-kubo/releases/tag/vX.Y.Z

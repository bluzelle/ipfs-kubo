...
which ends with this release: we've [removed](https://github.com/bluzelle/ipfs-kubo/pull/9048) the legacy implementation.
...
- https://hub.docker.com/r/bluzelle/ipfs-kubo/
...
- github.com/bluzelle/ipfs-kubo:
  ...
  - feat(routing): Delegated Routing (#8997) ([bluzelle/ipfs-kubo#8997](https://github.com/bluzelle/ipfs-kubo/pull/8997))
  - chore: changelogs split
  - feat(gw): Cache-Control: only-if-cached
  - chore(deps): webui v2.15.1
  - Follow-ups after repository rename
 ([bluzelle/ipfs-kubo#9098](https://github.com/bluzelle/ipfs-kubo/pull/9098))
  - docs: refine wording
  - docs: refine the wording of provider strategies
  - refactor: rename to kubo
 ([bluzelle/ipfs-kubo#8958](https://github.com/bluzelle/ipfs-kubo/pull/8958))
  - fix: correct cache-control in car responses
  - docs: v0.13.1 (#9093) ([bluzelle/ipfs-kubo#9093](https://github.com/bluzelle/ipfs-kubo/pull/9093))
  - chore: update go-car ([bluzelle/ipfs-kubo#9089](https://github.com/bluzelle/ipfs-kubo/pull/9089))
  - update go-libp2p to v0.20.3 ([bluzelle/ipfs-kubo#9038](https://github.com/bluzelle/ipfs-kubo/pull/9038))
  - docs: add SECURITY.md (#9062) ([bluzelle/ipfs-kubo#9062](https://github.com/bluzelle/ipfs-kubo/pull/9062))
  - fix: remove mdns_legacy & Discovery.MDNS.Interval
  - refactor: prealloc slices with known sizes (#8892) ([bluzelle/ipfs-kubo#8892](https://github.com/bluzelle/ipfs-kubo/pull/8892))
  - docs: fix typo in `cid/base32`
  - docs: mark Swarm.ResourceMgr as experimental
  - chore: replace ioutil with io and os (#8969) ([bluzelle/ipfs-kubo#8969](https://github.com/bluzelle/ipfs-kubo/pull/8969))
  ...
  - chore: bump Go to 1.18.3 (#9021) ([bluzelle/ipfs-kubo#9021](https://github.com/bluzelle/ipfs-kubo/pull/9021))
  - feat: upgrade to go-libp2p-kad-dht@v0.16.0 (#9005) ([bluzelle/ipfs-kubo#9005](https://github.com/bluzelle/ipfs-kubo/pull/9005))
  - docs: fix typo in the `swarm/peering` help text
  - feat: disable resource manager by default (#9003) ([bluzelle/ipfs-kubo#9003](https://github.com/bluzelle/ipfs-kubo/pull/9003))
  - fix: adjust rcmgr limits for accelerated DHT client rt refresh (#8982) ([bluzelle/ipfs-kubo#8982](https://github.com/bluzelle/ipfs-kubo/pull/8982))
  - fix(ci): make go-ipfs-as-a-library work without external peers (#8978) ([bluzelle/ipfs-kubo#8978](https://github.com/bluzelle/ipfs-kubo/pull/8978))
  - feat: log when resource manager limits are exceeded (#8980) ([bluzelle/ipfs-kubo#8980](https://github.com/bluzelle/ipfs-kubo/pull/8980))
  - fix: JS caching via Access-Control-Expose-Headers (#8984) ([bluzelle/ipfs-kubo#8984](https://github.com/bluzelle/ipfs-kubo/pull/8984))
  - docs: fix abstractions typo
  - fix: hanging goroutine in get fileArchive handler
  - chore: mark fuse experimental (#8962) ([bluzelle/ipfs-kubo#8962](https://github.com/bluzelle/ipfs-kubo/pull/8962))
  - fix(node/libp2p): disable rcmgr checkImplicitDefaults ([bluzelle/ipfs-kubo#8965](https://github.com/bluzelle/ipfs-kubo/pull/8965))
  - Add 'ipfs repo migrate' command (#8428) ([bluzelle/ipfs-kubo#8428](https://github.com/bluzelle/ipfs-kubo/pull/8428))
  - pubsub multibase encoding (#8933) ([bluzelle/ipfs-kubo#8933](https://github.com/bluzelle/ipfs-kubo/pull/8933))
  - 'pin rm' helptext: rewrite description as object is not removed from local storage (immediately) ([bluzelle/ipfs-kubo#8947](https://github.com/bluzelle/ipfs-kubo/pull/8947))
  -  ([bluzelle/ipfs-kubo#8934](https://github.com/bluzelle/ipfs-kubo/pull/8934))
  - Add instructions to resolve repo migration error (#8946) ([bluzelle/ipfs-kubo#8946](https://github.com/bluzelle/ipfs-kubo/pull/8946))

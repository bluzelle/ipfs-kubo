...
- github.com/bluzelle/ipfs-kubo:
  - chore: bump version to v0.17.0 ([bluzelle/ipfs-kubo#9427](https://github.com/bluzelle/ipfs-kubo/pull/9427))
  - chore: bump version to v0.17.0-rc2 ([bluzelle/ipfs-kubo#9414](https://github.com/bluzelle/ipfs-kubo/pull/9414))
  ...
  - docs: Deprecate Reframe on docs. (#9401) ([bluzelle/ipfs-kubo#9401](https://github.com/bluzelle/ipfs-kubo/pull/9401))
  - chore: bump version to v0.17.0-rc1 ([bluzelle/ipfs-kubo#9394](https://github.com/bluzelle/ipfs-kubo/pull/9394))
  - feat: Improve ResourceManager UX (#9338) ([bluzelle/ipfs-kubo#9338](https://github.com/bluzelle/ipfs-kubo/pull/9338))
  - feat: ipfs-webui 2.20.0
  - docs: note log tail is broken (#9383) ([bluzelle/ipfs-kubo#9383](https://github.com/bluzelle/ipfs-kubo/pull/9383))
  - feat(gateway): TAR response format (#9029) ([bluzelle/ipfs-kubo#9029](https://github.com/bluzelle/ipfs-kubo/pull/9029))
  ...
  - chore: delete snap configuration ([bluzelle/ipfs-kubo#9352](https://github.com/bluzelle/ipfs-kubo/pull/9352))
  - docs: update scoop package
  - docs: init release issue template improvement process v0.16.0 ([bluzelle/ipfs-kubo#9283](https://github.com/bluzelle/ipfs-kubo/pull/9283))
  - feat: add delegated routing metrics (#9354) ([bluzelle/ipfs-kubo#9354](https://github.com/bluzelle/ipfs-kubo/pull/9354))
  - chore: create v0.17.md changelog ([bluzelle/ipfs-kubo#9353](https://github.com/bluzelle/ipfs-kubo/pull/9353))
  - docs: pin remote arg
  - feat: webui@v2.19.0
  - test(car): export/import of (dag-)cbor/json codecs
  - add refs local alias repo ls (#9320) ([bluzelle/ipfs-kubo#9320](https://github.com/bluzelle/ipfs-kubo/pull/9320))
  - docs(cmds): Clarify block fetching of refs endpoint.
  - chore(cmds): dag import: use ipld legacy decode ([bluzelle/ipfs-kubo#9219](https://github.com/bluzelle/ipfs-kubo/pull/9219))
  - fix ipfs swarm peering crash in offline mode (#9261) ([bluzelle/ipfs-kubo#9261](https://github.com/bluzelle/ipfs-kubo/pull/9261))
  - feat: remove provider delay interval in bitswap (#9053) ([bluzelle/ipfs-kubo#9053](https://github.com/bluzelle/ipfs-kubo/pull/9053))
  - feat: --reset flag on swarm limit command (#9310) ([bluzelle/ipfs-kubo#9310](https://github.com/bluzelle/ipfs-kubo/pull/9310))
  - fix: add InlineDNSLink flag to PublicGateways config (#9328) ([bluzelle/ipfs-kubo#9328](https://github.com/bluzelle/ipfs-kubo/pull/9328))
  - docs: Fix typo and grammar in README
  - ci: add stylecheck to golangci-lint (#9334) ([bluzelle/ipfs-kubo#9334](https://github.com/bluzelle/ipfs-kubo/pull/9334))
  - Fix: `swarm stats all` command
  - Merge release v0.16.0 back into master ([bluzelle/ipfs-kubo#9324](https://github.com/bluzelle/ipfs-kubo/pull/9324))
  - fix: Set default Methods value to nil
  - docs: add WebTransport docs ([bluzelle/ipfs-kubo#9314](https://github.com/bluzelle/ipfs-kubo/pull/9314))

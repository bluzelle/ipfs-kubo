...
- Update Boxo to v0.10.3 ([ipfs/boxo#412](https://github.com/bluzelle/boxo/pull/412)).
...
Kubo now stores a subset of connected peers as backup bootstrap nodes ([kubo#8856](https://github.com/bluzelle/ipfs-kubo/pull/8856)).
These nodes are used in addition to the explicitly defined bootstrappers in the
[`Bootstrap`](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/config.md#bootstrap) configuration.
...
was only available in LAN contexts with [mDNS peer discovery](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/config.md#discoverymdns)
enabled.
...
[`Gateway.DeserializedResponses`](https://github.com/bluzelle/ipfs-kubo/blob/master/docs/config.md#gatewaydeserializedresponses)
configuration flag.
...
| ---- | ---- |
| ![DAG-CBOR Preview](https://github.com/bluzelle/boxo/assets/5447088/973f05d1-5731-4469-9da5-d1d776891899) | ![Error Page](https://github.com/bluzelle/boxo/assets/5447088/14c453df-adbc-4634-b038-133121914550) |
...
Rationale can be found in [kubo#9913](https://github.com/bluzelle/ipfs-kubo/pull/9913).
...
- github.com/bluzelle/ipfs-kubo:
  ...
  - fix(gateway): include CORS on subdomain redirects (#9994) ([bluzelle/ipfs-kubo#9994](https://github.com/bluzelle/ipfs-kubo/pull/9994))
  - fix: docker repository initialization race condition
  - chore: update version
  -  ([bluzelle/ipfs-kubo#9981](https://github.com/bluzelle/ipfs-kubo/pull/9981))
  -  ([bluzelle/ipfs-kubo#9960](https://github.com/bluzelle/ipfs-kubo/pull/9960))
  -  ([bluzelle/ipfs-kubo#9936](https://github.com/bluzelle/ipfs-kubo/pull/9936))
- github.com/bluzelle/boxo (v0.8.1 -> v0.10.2-0.20230629143123-2d3edc552442):
  - chore: version 0.10.2
  - fix(gateway): include CORS on subdomain redirects (#395) ([ipfs/boxo#395](https://github.com/bluzelle/boxo/pull/395))
  - fix(gateway): ensure 'X-Ipfs-Root' header is valid (#337) ([ipfs/boxo#337](https://github.com/bluzelle/boxo/pull/337))
  - docs: prepare changelog for next release [ci skip]
  - chore: version 0.10.1 (#359) ([ipfs/boxo#359](https://github.com/bluzelle/boxo/pull/359))
  - fix(gateway): allow CAR trustless requests with path
  - blockstore: replace go.uber.org/atomic with sync/atomic
  - fix(gateway): remove handleUnsupportedHeaders after go-ipfs 0.13 (#350) ([ipfs/boxo#350](https://github.com/bluzelle/boxo/pull/350))
  - docs: update RELEASE.md based on 0.9 release (#343) ([ipfs/boxo#343](https://github.com/bluzelle/boxo/pull/343))
  - chore: v0.10.0 (#345) ([ipfs/boxo#345](https://github.com/bluzelle/boxo/pull/345))
  - docs(changelog): car params from ipip-402
  - docs(changelog): add gateway deserialized responses (#341) ([ipfs/boxo#341](https://github.com/bluzelle/boxo/pull/341))
  - feat(gateway): implement IPIP-402 extensions for gateway CAR requests (#303) ([ipfs/boxo#303](https://github.com/bluzelle/boxo/pull/303))
  ...
  - changelog: add changelog for async pin listing (#336) ([ipfs/boxo#336](https://github.com/bluzelle/boxo/pull/336))
  - pinner: change the interface to have async pin listing
  - provider: revert throughput callback and related refactor
  - fix(gateway): question marks in url.Path when redirecting (#313) ([ipfs/boxo#313](https://github.com/bluzelle/boxo/pull/313))
  - fix(gateway)!: no duplicate payload during subdomain redirects (#326) ([ipfs/boxo#326](https://github.com/bluzelle/boxo/pull/326))
  - provider: add breaking changes to the changelog (#330) ([ipfs/boxo#330](https://github.com/bluzelle/boxo/pull/330))
  ...
  - feat(gateway): HTML preview for dag-cbor and dag-json (#315) ([ipfs/boxo#315](https://github.com/bluzelle/boxo/pull/315))
  - coreiface: add a testing.T argument to the provider
  - feat(gateway): improved templates, user friendly errors (#298) ([ipfs/boxo#298](https://github.com/bluzelle/boxo/pull/298))
  - feat(gateway)!: deserialised responses turned off by default (#252) ([ipfs/boxo#252](https://github.com/bluzelle/boxo/pull/252))
  - fix(gw): missing return in error case ([ipfs/boxo#319](https://github.com/bluzelle/boxo/pull/319))
  - feat(routing/http): pass records limit on routing.FindProviders (#299) ([ipfs/boxo#299](https://github.com/bluzelle/boxo/pull/299))
  - bitswap/client: fix PeerResponseTrackerProbabilityOneKnownOneUnknownPeer
  - feat(gw): add ipfs_http_gw_car_stream_fail_duration_seconds (#312) ([ipfs/boxo#312](https://github.com/bluzelle/boxo/pull/312))
  - feat(gw): add ipfs_http_gw_request_types metric (#311) ([ipfs/boxo#311](https://github.com/bluzelle/boxo/pull/311))
  - refactor: simplify ipns validation in example
  - feat: add deprecator
  - fix(routing/v1): add newline in NDJSON responses (#300) ([ipfs/boxo#300](https://github.com/bluzelle/boxo/pull/300))
  - feat(gateway): redirect ipns b58mh to cid (#236) ([ipfs/boxo#236](https://github.com/bluzelle/boxo/pull/236))
  - refactor: replace assert.Nil for assert.NoError
  - tar: add test cases for validatePlatformPath
  - feat(ipns): helper ValidateWithPeerID and UnmarshalIpnsEntry (#294) ([ipfs/boxo#294](https://github.com/bluzelle/boxo/pull/294))
  - Revert "feat: reusable ipns verify (#292)"
  - feat: reusable ipns verify (#292) ([ipfs/boxo#292](https://github.com/bluzelle/boxo/pull/292))
  - refactor: remove badger, leveldb dependencies (#286) ([ipfs/boxo#286](https://github.com/bluzelle/boxo/pull/286))
  - feat(routing/http): add streaming support (#18) ([ipfs/boxo#18](https://github.com/bluzelle/boxo/pull/18))
  - feat(routing): allow-offline with routing put (#278) ([ipfs/boxo#278](https://github.com/bluzelle/boxo/pull/278))
  - refactor(gateway): switch to xxhash/v2 (#285) ([ipfs/boxo#285](https://github.com/bluzelle/boxo/pull/285))

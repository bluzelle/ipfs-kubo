...
import (
	...
	"github.com/bluzelle/ipfs-kubo/repo/common"
	dir "github.com/bluzelle/ipfs-kubo/thirdparty/dir"
	filestore "github.com/ipfs/go-filestore"
	keystore "github.com/ipfs/go-ipfs-keystore"

	config "github.com/bluzelle/ipfs-kubo/config"
	serialize "github.com/bluzelle/ipfs-kubo/config/serialize"
...
func (r *FSRepo) openDatastore() error {
	...
	if r.config.Datastore.NoSync {
		log.Warn("NoSync is now deprecated in favor of datastore specific settings. If you want to disable fsync on flatfs set 'sync' to false. See https://github.com/bluzelle/ipfs-kubo/blob/master/docs/datastores.md#flatfs.")
	}
...
// https://github.com/bluzelle/ipfs-kubo/issues/8088 for more details).

...
.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/pollEndpoint
$(d)/pollEndpoint: github.com/bluzelle/ipfs-kubo/test/dependencies/pollEndpoint
	$(go-build-testdep)
TGTS_$(d) += $(d)/pollEndpoint

.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/go-sleep
$(d)/go-sleep: github.com/bluzelle/ipfs-kubo/test/dependencies/go-sleep
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-sleep

.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/graphsync-get
$(d)/graphsync-get: github.com/bluzelle/ipfs-kubo/test/dependencies/graphsync-get
	$(go-build-testdep)
TGTS_$(d) += $(d)/graphsync-get

.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/go-timeout
$(d)/go-timeout: github.com/bluzelle/ipfs-kubo/test/dependencies/go-timeout
	$(go-build-testdep)
TGTS_$(d) += $(d)/go-timeout

.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/iptb
$(d)/iptb: github.com/bluzelle/ipfs-kubo/test/dependencies/iptb
	$(go-build-testdep)
TGTS_$(d) += $(d)/iptb

.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/ma-pipe-unidir
$(d)/ma-pipe-unidir: github.com/bluzelle/ipfs-kubo/test/dependencies/ma-pipe-unidir
	$(go-build-testdep)
TGTS_$(d) += $(d)/ma-pipe-unidir

.PHONY: github.com/bluzelle/ipfs-kubo/test/dependencies/json-to-junit
$(d)/json-to-junit: github.com/bluzelle/ipfs-kubo/test/dependencies/json-to-junit
	$(go-build-testdep)

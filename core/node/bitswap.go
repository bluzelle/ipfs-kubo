...
import (
	...
	"github.com/bluzelle/boxo/bitswap"
	"github.com/bluzelle/boxo/bitswap/network"
...
// Docs: https://github.com/bluzelle/ipfs-kubo/blob/master/docs/config.md#internalbitswap
const (

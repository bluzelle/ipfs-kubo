...
import (
	...
	"github.com/bluzelle/ipfs-kubo/core/coreunix"

	blockservice "github.com/bluzelle/boxo/blockservice"
	...
	dagtest "github.com/bluzelle/boxo/ipld/merkledag/test"
	ft "github.com/bluzelle/boxo/ipld/unixfs"
	unixfile "github.com/bluzelle/boxo/ipld/unixfs/file"
...
func (api *UnixfsAPI) Add(ctx context.Context, files files.Node, opts ...options.UnixfsAddOption) (path.ImmutablePath, error) {
	...
	if settings.NoCopy && !(cfg.Experimental.FilestoreEnabled || cfg.Experimental.UrlstoreEnabled) {
		return path.ImmutablePath{}, fmt.Errorf("either the filestore or the urlstore must be enabled to use nocopy, see: https://github.com/bluzelle/ipfs-kubo/blob/master/docs/experimental-features.md#ipfs-filestore")
	}
